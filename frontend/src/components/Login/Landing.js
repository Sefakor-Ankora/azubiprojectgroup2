...
const Landing = () => {
  ...
  <div className="flex-grow pa3 flex items-center">
    ...
    <div className='begin'>
      <div className="tc-l mt4 mt5-m mt6-l ph3">
        ...
        <a className="f6 no-underline grow dib v-mid bg-white black ba b--white ph3 pv2 mb3" href="/">Get ticket</a>
      </div>
      </div>
      </div>
    </header>
  ...
  <article>
    <a className="link dt w-100 bb b--black-10 pb2 mt2 dim blue" href="/">
      <div className="dtc w3">
        <img src="https://images.pexels.com/photos/1181354/pexels-photo-1181354.jpeg?cs=srgb&dl=pexels-christina-morillo-1181354.jpg&fm=jpg" className="db w-100" alt="conference 1" />
      </div>
